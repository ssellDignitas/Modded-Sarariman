<%-- 
    Document   : UC_invoices
    Created on : Jun 8, 2011, 2:16:49 PM
    Author     : root
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script type="text/javascript">
            $(function() {		
                $("#invoice_table").tablesorter({sortList:[[0,0]], widgets: ['zebra']});
            });	
        </script>  
        </script>
                                ...
                                <div id="holder">
                                    <div class="drop-shadow curved curved-hz-2">
                                        <p>
                                            ...
                                            <table id="invoice_table" class="tablesorter">
                                                <thead>
                                                    <th>Invoice</th>
                                                    <th>Sent</th>
                                                    <th>Project</th>
