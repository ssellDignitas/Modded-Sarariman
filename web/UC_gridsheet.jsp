<%-- 
    Document   : UC_gridsheet
    Created on : Jul 22, 2011, 11:37:06 AM
    Author     : root
--%>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <a href="http://www.google.com" rel="#overlay"><button type="button">test</button></a>
        ...
        <button type="button" id="TimeGrid_Remove" class="removeFields button remove">Remove</button>
        <button type="button" id="TimeGrid_Add" class="addFields button add">Add</button>
            ...
            <tbody>
                ...
                <tr id="task_row">
                    ...
                    <td id="task_sat" style="min-height:20px;height:20px;max-height:20px;">
                        <input size="5" type="text" id="duration_Sat" disabled="true" style="width:65px;"/>              
                    ...
                    <td id="task_sun" style="min-height:20px;height:20px;max-height:20px;">
                        <input size="5" type="text" id="duration_Sun" disabled="true" style="width:65px;"/>              
                    ...
                    <td id="task_mon" style="min-height:20px;height:20px;max-height:20px;">
                        <input size="5" type="text" id="duration_Mon" disabled="true" style="width:65px;"/>              
                    ...
                    <td id="task_tue" style="min-height:20px;height:20px;max-height:20px;">
                        <input size="5" type="text" id="duration_Tue" disabled="true" style="width:65px;"/>              
                    ...
                    <td id="task_wed" style="min-height:20px;height:20px;max-height:20px;">
                        <input size="5" type="text" id="duration_Wed" disabled="true" style="width:65px;"/>              
                    ...
                    <td id="task_thu" style="min-height:20px;height:20px;max-height:20px;">
                        <input size="5" type="text" id="duration_Thu" disabled="true" style="width:65px;"/>             
                    ...
                    <td id="task_fri" style="min-height:20px;height:20px;max-height:20px;">
                        <input size="5" type="text" id="duration_Fri" disabled="true" style="width:65px;"/>              
        ...
        <button type="button" id="descriptionButton" class="button description">Comment</button>
        <br />
        <textarea cols="74" rows="10" name="description" id="description" class="hide_me">Optional Description</textarea>
        <br />
        
        <!-- ### Form for future/past unfilled dates ### -->
        ...
        <iframe name="take_the_punch" id="take_the_punch" />
        
        <button type="button" id="submitButton" name="submitButton" class="button submit">Submit</button>
        ...
        <div id="formHolder" style="background-color:#AACCAA; border:0px;width:70%;margin:auto;">
            form goes here
        </div>
        
        <br /><br /><br />
        
        <div style="width:90%;margin:auto;background-color:#CC8888;color:#000;overflow:auto;padding:10px;border:1px dotted black;">
            
            <span style="font-size:3em;color:#992222;">BIG RED BOX</span>
            ...
            <ol>
                <li><s>Time edited to 0 bug</s> (once it wants to use the updated .js file...)</li>
                <li><s>New row adding data that belongs to old row</s></li>
                <li><s>Modify past and future empty cells</s></li>              
                <li><s>Row sum totals</s></li>
                <li>TimeRewards style form edit reveal</li>
            </ol>
            ...
            <ol>
                <li><s>iFrame target not working</s></li>
                <li>empty cell height != occupied cell height</li>
            </ol>
